...
se.dataword_to_codeword(list_of_frames,no_of_bits=err.no_of_bits, error_list_frames=[1,2], error_bit_list=[[0],[0]])
re.combiner()
print('--------------------------------------------------------------------------')
...
se.dataword_to_codeword(list_of_frames,no_of_bits=err.no_of_bits, error_list_frames=[1], error_bit_list=[[0, 4]])
re.combiner()
print('--------------------------------------------------------------------------')