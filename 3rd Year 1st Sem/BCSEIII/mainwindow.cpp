...
//    int x0=(p1.x()/gridsize)*gridsize+gridsize/2,y0=(p1.y()/gridsize)*gridsize+gridsize/2,x1=p2.x(),y1=p2.y();
//    int dx=p2.x()-p1.x(),dy=p2.y()-p1.y();
//    int stepx,stepy;
//    if(dy<0){dy=-dy; stepy=-gridsize;} else {stepy=gridsize;}
//    if(dx<0){dx=-dx; stepx=-gridsize;} else {stepx=gridsize;}

//    dy<<=1;dx<<=1;

//    point(p1.x(),p1.y(),255,111,0);
